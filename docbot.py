...
st.caption("Type your question below and press **Enter** or click the **Search** button.")

col1, col2 = st.columns([5,1])

with col1:
    user_query = st.text_input("Ask a question about your uploaded documents:", key="user_query", label_visibility="collapsed")
